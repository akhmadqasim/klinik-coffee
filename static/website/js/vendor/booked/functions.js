...
;(function($, window, document, undefined) {
	...
	var ajaxforgot = $('#ajaxforgot');
	var ajaxlogin = $('#ajaxlogin');
	var profile_forgot = $('#profile-forgot');
	var booked_tab_content = $('.booked-tab-content');
	var booked_list_view = $('.booked-list-view');
	...
	$win.on('load', function() {
		...
		adjust_calendar_boxes();
		var booked_calendar_wrap = $('.booked-calendar-wrap');
	    ...
	    body.on('submit','form#ajaxforgot', function(e){
			"use strict";
		    e.preventDefault();
			var p_status = $('form#ajaxforgot p.status');
		...
		body.on('click','.booked-form input#submit-request-appointment',function(e){
			"use strict";
			var  newAppointmentForm_status = $('form#newAppointmentForm p.status');
		...
		var SubmitRequestAppointment = {
			...
			_addCustomFieldsData: function( data, calendar_id ) {
				var custom_fields_data = $('.cf-block [name]')
					.filter( function( index ) {
						var $this = $(this);
						return parseInt($this.data('calendar-id'),10) === parseInt(calendar_id,10) && $this.attr('name').match(/---\d+/g);
					} )
					.each( function( index ) {
						var $this = $(this),
							name = $this.attr('name'),
			...
			_reloadApptsList: function() {
				...
				$('.booked-appt-list').each( function() {
					...
					var $thisApptList  = $(this),
						...
						defaultDate   = thisList.attr('data-default'),
						calendar_id   = parseInt($thisApptList.find('.booked-list-view-nav').attr('data-calendar-id'),10) || 0;
			...
			_reloadCalendarTable: function() {
				...
				var $activeTD = $('td.active'),
					...
					calendar_id = parseInt( $activeTD.parents('table').data('calendar-id') ,10) || 0;
